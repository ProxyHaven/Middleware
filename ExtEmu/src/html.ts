...
const lib: HTMLHandler = {
	handle: el => {
		// Chrome Web Store
		if (
			location.href.startsWith("https://chrome.google.com/webstore/detail/")
		) {
			const btn = document.querySelector(".g-c-R  .webstore-test-button-label");
		...
		// Firefox Addons
			...
			if (btn instanceof HTMLAnchorElement) {
				fixBtn(btn, "Add to Firefox", install.bind(this, btn.href, "FF"));
			}
		}
		// Apple Store 🤓
